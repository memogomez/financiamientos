...
@section('title', 'Editar - Areas | Sigi')
...
<div class="page-title">
  <div class="row">
    <div class="col-12 col-md-6 order-md-1 order-last">
      <h3>Editar area</h3>
      <p class="text-subtitle text-muted">Modifica los datos del area seleccionada</p>
    </div>
            ...
            <form action="{{ route('areas.update', $area) }}" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-12">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="estatus" id="estatus">
                      <option value="1" @selected(old('estatus', $area->estatus) == 1)>Activo</option>
                      <option value="0" @selected(old('estatus', $area->estatus) == 0)>Inactivo</option>
                    </select>
                    @error('estatus')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-12 d-flex justify-content-end gap-2">
                  <a href="{{ route('areas.show') }}" class="btn btn-light-secondary me-1 mb-1">Cancelar</a>
